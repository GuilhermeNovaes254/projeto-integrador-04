...
-- Schema looders
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `looders` DEFAULT CHARACTER SET utf8 ;
USE `looders` ;

-- -----------------------------------------------------
-- Table `looders`.`privilegio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`privilegio` (
...
-- -----------------------------------------------------
-- Table `looders`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_privilegio1`
    ...
    REFERENCES `looders`.`privilegio` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `looders`.`tema`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`tema` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `looders`.`dominio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`dominio` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `looders`.`mecanica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`mecanica` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(80) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- Table `looders`.`jogo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`jogo` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(100) NOT NULL,
  `ano` YEAR(4) NULL,
...
-- -----------------------------------------------------
-- Table `looders`.`usuarioJogo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`usuarioJogo` (
  ...
  CONSTRAINT `fk_usuario_has_jogo_usuario1`
    ...
    REFERENCES `looders`.`usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_has_jogo_jogo1`
    FOREIGN KEY (`jogo_id`)
    REFERENCES `looders`.`jogo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `looders`.`avaliacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`avaliacao` (
  `usuario_id` INT NOT NULL,
  `jogo_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `looders`.`favorito`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`favorito` (
  `usuario_id` INT NOT NULL,
  `jogo_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `looders`.`joguei`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `looders`.`joguei` (
  `usuario_id` INT NOT NULL,
  `jogo_id` INT NOT NULL,
